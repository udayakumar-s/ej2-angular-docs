---
layout: post
title: File attachment in Angular Rich text editor component | Syncfusion
description: Learn here all about File attachment in Syncfusion Angular Rich text editor component of Syncfusion Essential JS 2 and more.
