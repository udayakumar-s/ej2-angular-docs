---
layout: post
title: Style in Angular Combo box component | Syncfusion
description: Learn here all about Style in Syncfusion Angular Combo box component of Syncfusion Essential JS 2 and more.
...
{% include code-snippet/combobox/asterisk-cs1/app/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="app.module.ts" %}
{% include code-snippet/combobox/asterisk-cs1/app/app.module.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/combobox/asterisk-cs1/app/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "page.domainurl/samples/combobox/asterisk-cs1" %}
