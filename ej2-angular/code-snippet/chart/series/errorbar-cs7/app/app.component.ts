...
export class AppComponent implements OnInit {
    ...
    public chartData: Object[] =  [
        { x: 2006, y: 7.8, color: 'red', error: 5 }, { x: 2007, y: 7.2, color: 'green', error: 5 },
        { x: 2008, y: 6.8, color: 'blue', error: 5 }, { x: 2009, y: 5.7, color: 'yellow', error: 5 },
        { x: 2010, y: 10.8, color: 'grey', error: 5 }, { x: 2011, y: 9.8, color: 'brown', error: 5 }
    ];
    public title: string;
