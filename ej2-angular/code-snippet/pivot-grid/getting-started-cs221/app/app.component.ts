...
import { IDataOptions, PivotView, VirtualScrollService, ExportCompleteEventArgs, PDFExportService } from '@syncfusion/ej2-angular-pivotview';
...
export class AppComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.button.element.onclick = (): void => {
            ...
            this.pivotGridObj.pdfExport(pdfExportProperties, false, null, true);
        };
    }
}
