...
3. **[Template Support](how-to/render-other-components-in-toolbar-using-angular-template/)** : The Toolbar complete component can also be rendered based on the given HTML element.
